...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep  2 09:07:43 2018
...
class LossBinary_lovasz:
    ...
    def __call__(self, outputs, targets):
        loss = (1 - self.weight) * binary_xloss(outputs, targets, ignore=None)

        if self.weight:
            loss += self.weight * (lovasz_hinge(per_image=False, ignore=None)(outputs, targets))
        return loss

...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 26 19:06:14 2018
...
class LinkNet34(nn.Module):
    def __init__(self, num_classes=1, num_channels=3,  pretrained=True):
        ...
        self.decoder4 = nn.Sequential(DecoderBlock(filters[3]+ filters[1],filters[3], filters[1],is_deconv=True),
                                       ModifiedSCSEBlock(filters[1],4))
        self.decoder3 = nn.Sequential(DecoderBlock(filters[2]+ filters[1],filters[2], filters[1],is_deconv=True),
                                      ModifiedSCSEBlock(filters[1],4))
        self.decoder2 = nn.Sequential(DecoderBlock(filters[1]+ filters[1],filters[1], filters[1],is_deconv=True),
                                      ModifiedSCSEBlock(filters[1],4))
        self.decoder1 = nn.Sequential(DecoderBlock(filters[0]+ filters[1],filters[0], filters[1],is_deconv=True),
                                      ModifiedSCSEBlock(filters[1],4))
        ...
        self.finalconv2 = nn.Conv2d(704, 32, 3,padding=1)

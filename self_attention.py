...
model =  SelfAttentionBlock2D(100, 100, 100, out_channels=3, scale=1).to(device)
model1 = BaseOC_Context_Module(512, 512, 128, 128, 0.05, sizes=([1])).to(device)
summary(model1, (512, 128, 128))
